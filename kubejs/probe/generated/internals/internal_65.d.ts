...
declare namespace net.mehvahdjukaar.every_compat.common_classes {
    class CompatTrappedChestBlock extends Internal.CompatChestBlock {
        ...
        */
        ...
        handler$cpl000$addSimpleFastECdrops(state: Internal.BlockState_, builder: Internal.LootParams$Builder_, cir: Internal.CallbackInfoReturnable_<any>, resId: ResourceLocat